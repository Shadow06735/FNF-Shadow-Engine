...
{
	public static var shadowEngineVersion:String = '1.1.1h'; // This is also used for Discord RPC
	...
	override function create()
	{
		...
		var shadowEngineLogo:FlxSprite = new FlxSprite(-45, FlxG.height - 95).loadGraphic(Paths.image('shadowEngineLogo'));
